...
namespace BakeryManagement {
	...
	/// <summary>
	/// Summary for BakerySearchForm
	/// </summary>
	public ref class BakerySearchForm : public System::Windows::Forms::Form
	{
	public:
		BakerySearchForm(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Text = L"Search item";
			this->button1->UseVisualStyleBackColor = true;
			this->button1->Click += gcnew System::EventHandler(this, &BakerySearchForm::button1_Click);
			// 
			// BakerySearchForm
			// 
			...
			this->Name = L"BakerySearchForm";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"Bakery Search Form";
			this->Load += gcnew System::EventHandler(this, &BakerySearchForm::BakerySearchForm_Load);
...
#pragma endregion
	private: System::Void BakerySearchForm_Load(System::Object^ sender, System::EventArgs^ e) {
	}
